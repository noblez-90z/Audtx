...
const MainNewsDetails = () => {
  ...
  return (
    <div className="border  bg-[#121212]">
      <div className="container relative mx-auto px-4 py-6  rounded md:w-1/2 mt-6 px-3 bg-[#1C1C1C] text-white">
        <div className="mt-6">
        ...
        <div className="mb-6 mt-6">
          ...
          <ul className="space-y-4">
            {newsItem.comments.map((comment) => (
              <li key={comment.id} className=" px-3 rounded">
        ...
        <div
          className=" w-fit absolute top-2 left-3 cursor-pointer "
